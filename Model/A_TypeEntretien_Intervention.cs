...
namespace Projet_Garage.Acces
{
 ...
 /// </summary>
 public class A_TypeEntretien_Intervention : ADBase
 {
  #region Constructeurs
  public A_TypeEntretien_Intervention(string sChaineConnexion)
  	: base(sChaineConnexion)
  { }
  #endregion
  public int Ajouter(int? interventionId, int? entretienId, double? prixHeure, double? prix, double? tva)
  {
   CreerCommande("AjouterTypeEntretien_Intervention");
   int res = 0;
  ...
  {
   CreerCommande("ModifierTypeEntretien_Intervention");
   int res = 0;
  ...
  {
   CreerCommande("SelectionnerTypeEntretien_Intervention");
   Commande.Parameters.AddWithValue("@Index", Index);
   Commande.Connection.Open();
   SqlDataReader dr = Commande.ExecuteReader();
   List<C_TypeEntretien_Intervention> res = new List<C_TypeEntretien_Intervention>();
   while (dr.Read())
   {
    C_TypeEntretien_Intervention tmp = new C_TypeEntretien_Intervention();
  ...
  {
   CreerCommande("SelectionnerTypeEntretien_Intervention_ID");
   Commande.Parameters.AddWithValue("@id", id);
   Commande.Connection.Open();
   SqlDataReader dr = Commande.ExecuteReader();
   C_TypeEntretien_Intervention res = new C_TypeEntretien_Intervention();
   while (dr.Read())
   {
  ...
  {
   CreerCommande("SupprimerTypeEntretien_Intervention");
   int res = 0;
   Commande.Parameters.AddWithValue("@id", id);
   Commande.Connection.Open();
