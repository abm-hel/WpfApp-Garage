...
namespace Projet_Garage.Model
{
 ...
 /// </summary>
 public class C_Entretien_Intervention
 {
  ...
  public C_Entretien_Intervention()
  { }
  public C_Entretien_Intervention(int? interventionId_, int? entretienId_, double? prixHeure_, double? prix_, double? tva_)
  {
  ...
  public C_Entretien_Intervention(int id_, int? interventionId_, int? entretienId_, double? prixHeure_, double? prix_, double? tva_)
